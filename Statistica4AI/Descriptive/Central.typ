...
$ q = cases(x_(\u{230A} n p \u{230B} + 1) & "se" n p "non é intero",
            frac(1, 2) (x_(n p) + x_(n p + 1)) & "se" n p "é intero") $
...
#exercise[
	Given the following sample, compute the first, second and third
	quantile and draw the corresponding box plot:
...
#solution[
	...
	#figure(image("boxplot.svg", width: 50%))
]
