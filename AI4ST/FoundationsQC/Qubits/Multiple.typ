...
Measuring the state of a $n$-qubit system follows the same idea as measuring
the state of a single-qubit system, but the set of possible measurements and
measurement outcomes is significantly larger than in the single-qubit case.
