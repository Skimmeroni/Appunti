...
#proof[
	...
	$ P(X gt.eq t + t_(0) | X gt.eq t_(0)) & = frac(P[(X gt.eq t + t_(0)) inter
...
#grid(
	columns: (0.5fr, 0.5fr),
	[#figure(image("chisquared_PDF.svg"))],
	[#figure(image("chisquared_CDF.svg"))]
)
...
a Chi-squared distribution with $n$ degrees of freedom, independent of each
...
#grid(
	columns: (0.5fr, 0.5fr),
	[#figure(image("student_t_PDF.svg"))],
	[#figure(image("student_t_CDF.svg"))]
)
