...
#proof[
	...
	$ (sum_(i = 1)^(n) x_(i)) frac(1, hat(p)) - frac(n, 1 - hat(p)) +
	  ...
	  frac(n, 1 - hat(p)) &= 0 =>
	  (sum_(i = 1)^(n) x_(i)) (frac(1, hat(p))) - n = 0 =>
...
#proof[
	...
	$ f(x_(1), x_(2), dots, x_(n) | lambda) &=
	  ...
	  frac(lambda^(x_(n)) e^(-lambda), x_(n) !) =
	  e^(-n lambda) frac(lambda^(sum_(i = 1)^(n) x_(i)), product_(i = 1)^(n) x_(i) !) $
...
#proof[
	...
	$ frac(d, d mu) (-frac(n, 2) log(2 pi) -n log(sigma)
	  ...
	  0 + 0 cancel(-frac(1, 2 sigma^(2))) frac(d, d mu) (sum_(i = 1)^(n) (x_(i) - mu)^(2)) = 0 =>
	  sum_(i = 1)^(n) frac(d, d mu) (x_(i) - mu)^(2) &= 0 => \
	  sum_(i = 1)^(n) 2(x_(i) - mu) frac(d, d mu) (x_(i) - mu) = 0 =>
	...
	$ frac(d, d sigma) (-frac(n, 2) log(2 pi) -n log(sigma)
	  ...
	  sum_(i = 1)^(n) (x_(i) - mu)^(2)) &= 0 => \
	  0 -n frac(d, d sigma) (log(sigma)) - (sum_(i = 1)^(n) (x_(i) - mu)^(2))
	  frac(d, d sigma) (frac(1, 2 sigma^(2))) &= 0 => \
	...
	$ 0 = -frac(n, hat(sigma)) + frac(1, hat(sigma)^(3)) sum_(i = 1)^(n) (x_(i) - hat(mu))^(2) &=>
	  n hat(sigma)^(2) = sum_(i = 1)^(n) (x_(i) - overline(x))^(2) => 
