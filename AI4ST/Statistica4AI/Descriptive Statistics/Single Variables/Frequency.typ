...
#solution[
	#figure(
		caption: [On the left, the bar plot of the absolute frequencies
		          for the given dataset. On the right, the bar plot of
		          the relative frequencies.],
		[#grid(
			columns: (0.5fr, 0.5fr),
			[#figure(image("barplot_absolute.svg"))],
			[#figure(image("barplot_relative.svg"))]
		)]
	)
]
