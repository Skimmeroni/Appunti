...
#solution[
	...
	#figure(
		...
		[#diagram(
			...
			node((-1, 0.5), radius: 2em, name: <I1>),
			node((-1, -0.5), radius: 2em, name: <I2>),
			node((-1, 1.5), radius: 2em, name: <I3>),
			node((0, 0.5), stroke: 1.5pt + green, text(font: "Noto Sans", [-1]), radius: 2em, name: <H1>),
			node((0, -0.5), stroke: 1.5pt + green, text(font: "Noto Sans", [+1]), radius: 2em, name: <H2>),
			node((1, 0), stroke: 1.5pt + green, text(font: "Noto Sans", [+1]), radius: 2em, name: <H3>),
			node((0, 1.5), stroke: 1.5pt + green, text(font: "Noto Sans", [-1]), radius: 2em, name: <H4>),
			node((1, 1), stroke: 1.5pt + green, text(font: "Noto Sans", [+1]), radius: 2em, name: <H5>),
